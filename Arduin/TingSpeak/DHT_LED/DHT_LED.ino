...
LedControl lc = LedControl(18, 5, 4, 1);
...
const char* url = "/channels/341141/fields/3/last";
...
{ 
  ...
  int t = cTemp * 10;
  int h = Humid* 10;
  lc.setDigit(0, 7, t / 100, false);
  lc.setDigit(0, 6, (t % 100) / 10, true);
  lc.setDigit(0, 5, t % 10, false);
  lc.setDigit(0, 4, 12, false);
  lc.setDigit(0, 3, h / 100, false);
  lc.setDigit(0, 2, (h / 10) % 10, true);
